...
// for RGB Clock Internl BME280 Temp Display
String showTemp;
...
//  centerPrint("....");
    ...
    String msg = "";
    msg += " Time Offset is " + (String(UtcOffset));
    scrollMessage(msg);
    }
...
//    description.toUpperCase();
    ...
    String msg;   
    msg += "    Currently in " + weatherClient.getCity(0);
    msg += " it's "+ temperature + " degrees, with " + description + ",  ";
    msg += "the humidity is " + weatherClient.getHumidityRounded(0) + "%  ";
    msg += "and the wind is blowing up to " + weatherClient.getWindRounded(0) + getSpeedSymbol() + ".        ";
    msg += marqueeMessage + " ";
    if (NEWS_ENABLED) {
      msg += "  Headline News from " + NEWS_SOURCE + ": " + newsClient.getTitle(newsIndex) + "   ";
      newsIndex += 1;
      if (newsIndex > 9) {
        newsIndex = 0;
      }
...
//  centerPrint(hourMinutes);
  centerPrint(showTemp);
//  centerPrint(temperature);
